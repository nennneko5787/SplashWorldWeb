...
<html lang="ja" data-bs-theme="auto">
  <head>
    ...
    <script src="./togglecolor.js"></script>
  </head>
  <body>
...
<header class="navbar navbar-expand-lg bd-navbar sticky-top">
  <nav class="container-xxl bd-gutter flex-wrap flex-lg-nowrap" aria-label="Main navigation">
    ...
    <a class="navbar-brand p-0 me-0 me-lg-2" href="/" aria-label="SplashWorld">
      SplashWorld
    </a>
    ...
    <div class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel" data-bs-scroll="true">
      <div class="offcanvas-header px-4 pb-0">
        <h5 class="offcanvas-title text-white" id="bdNavbarOffcanvasLabel">SplashWorld</h5>
      ...
      <div class="offcanvas-body p-4 pt-0 p-lg-0">
        ...
        <ul class="navbar-nav flex-row flex-wrap bd-navbar-nav">
          <li class="nav-item col-6 col-lg-auto">
            <a class="nav-link py-2 px-0 px-lg-2 active" aria-current="true" href="#">ホーム</a>
          </li>
          <li class="nav-item col-6 col-lg-auto">
            <a class="nav-link py-2 px-0 px-lg-2" href="#learn">SplashWorldとは</a>
          </li>
          <li class="nav-item col-6 col-lg-auto">
            <a class="nav-link py-2 px-0 px-lg-2" href="#join" target="_blank" rel="noopener">遊んでみる</a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
          <li class="nav-item col-6 col-lg-auto">
            <a class="nav-link py-2 px-0 px-lg-2" href="https://discord.gg/fypgvx3eJb" target="_blank" rel="noopener">
